...
- Enfocar un campo de Food no desplaza la pantalla al fondo.
- Enfocar el nombre de un evento importante no desplaza Semana al fondo.
...
- [ ] AC1 — Food no contiene `scrollToEnd()` asociado al foco de inputs.
- [ ] AC2 — Semana/Eventos importantes no contiene `scrollToEnd()` asociado al foco.
